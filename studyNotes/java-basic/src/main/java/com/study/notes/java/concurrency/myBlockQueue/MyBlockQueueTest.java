...
public class MyBlockQueueTest {
    ...
    private final static Logger LOGGER = LoggerFactory.getLogger(MyBlockQueueTest.class) ;
    ...
    @Test
    public void put() {
        MyBlockQueue<String> queue = new MyBlockQueue<>(3);
        queue.put("123");
        queue.put("1234");
        queue.put("12345");
    ...
    @Test
    public void put2() {
        final MyBlockQueue<String> queue = new MyBlockQueue<>(3);
    ...
    public void put4() throws InterruptedException {
        final MyBlockQueue<String> queue = new MyBlockQueue<>(299);
    ...
    public void put5() throws InterruptedException {
        final MyBlockQueue<String> queue = new MyBlockQueue<>(1000000);
    ...
    public void get2() throws InterruptedException {
        MyBlockQueue<String> queue = new MyBlockQueue<>(100);
        Thread t1 = new Thread(() -> {
            for (int i = 0; i < 50; i++) {
                try {
                    queue.put(i + "");
